...
namespace Wordki.ViewModels {
  ...
  public class BuildFromFileViewModel : INotifyPropertyChanged, IViewModel {
    ...
    private ObservableCollection<Pair<string, string>> _pairs;
    public ObservableCollection<Pair<string, string>> Pairs
    {
      get { return _pairs; }
      set
      {
    ...
    public BuildFromFileViewModel() {
      ...
      Pairs = new ObservableCollection<Pair<string, string>>();
    }
    ...
    private async void SaveGroup(object obj) {
      ...
      foreach (Pair<string, string> pair in Pairs) {
        Word newWord = new Word {
          GroupId = newGroup.Id,
          Language1 = pair.Value1,
          Language2 = pair.Value2,
        };
      ...
      Task.Run(() => {
        ...
        foreach (string line in lines) {
          ...
          Pair<string, string> pair = new Pair<string, string> {
            Value1 = word[0].Trim(' ', '\r', '\n'),
            Value2 = word[1].Trim(' ', '\r', '\n')
          };
          Pairs.Add(pair);
        }
      });
