...
namespace Wordki.LocalDatabase
{
    public class SqliteConnection
    {
        ...
        private const string translationDireciton = "translationDirection";
        ...
        public int UpdateUser(User pUser)
        {
            ...
            lBuilder.Append("UPDATE ")
              ...
              .Append(downloadDate).Append(" = ").Append("@").Append(downloadDate).Append(", ")
              .Append(translationDireciton).Append(" = ").Append("@").Append(translationDireciton).Append(", ")
              .Append(allWords).Append(" = ").Append("@").Append(allWords)
              .Append(" WHERE ")
